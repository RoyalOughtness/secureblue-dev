...
rpm-ostree override remove flite apr-util-openssl apr-util-lmdb apr-util apr httpd-tools avahi-gobject avahi-tools cifs-utils cifs-utils-info fprintd fprintd-pam espeak-ng spice-webdavd spice-vdagent orca speech-dispatcher speech-dispatcher-espeak-ng speech-dispatcher-libs speech-dispatcher-utils
